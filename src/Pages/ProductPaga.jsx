      ...
      <main id="container">
        ...
        <div className="ProductPaga-container top-bottom-padding left-right-padding">
          ...
          <div className="product-img-video">
            <img src={`./image/ProductImage/${product.image}`} alt="" />
          </div>
          {/* ---------- */}
          <div className="product-detail" style={{ padding: "1rem" }}>
            ...
            <div className="product-detail-name top-bottom-padding">
              ...
              <div className="top-bottom-padding">Inclusive of all taxes</div>
              <div>
                <span className="bold">EMI</span> starts at ₹{product.emi}. No
                Cost EMI available{" "}
                <span className="product-link">EMI options</span>
              </div>
            </div>
            <div className="product-detail-name top-bottom-padding">
          ...
          <div className="product-buying-detail" style={{ padding: "1rem" }}>
            ...
            <p className="bold top-bottom-padding">
              <span className="product-link">FREE delivery</span>{" "}
              {product.delivery} <span className="product-link">Details</span>
            </p>
            <p className="bold top-bottom-padding">
              Or fastest delivery Tomorrow, May 2. Order within 8 hrs 17 mins.{" "}
              <span className="product-link">Details</span>
            </p>
...
export const ColorSelector = ({ Product }) => {
  ...
  return (
    <div className="product-detail-name top-bottom-padding">
      <p>
        Colour: <span className="bold">{color}</span>
      </p>
      <div
        className="flexBox top-bottom-padding"
